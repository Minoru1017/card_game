...
public partial class BattleSimulationDebugUI : MonoBehaviour
{
    ...
    private void EnsureDiscardSelectionUi(Transform parent)
    {
        ...
        zoneImg.color = new Color(0.18f, 0.19f, 0.23f, 1f);
        ...
        discardDropZoneText.color = new Color(0.97f, 0.94f, 0.84f, 1f);
        ...
        promptObj.GetComponent<Image>().color = new Color(0.12f, 0.13f, 0.16f, 0.96f);
        ...
        discardPromptText.color = new Color(1f, 0.93f, 0.55f, 1f);
    ...
    public void SetDiscardDropZoneHover(bool hovering)
    {
        if (discardDropZoneImage != null)
        {
            discardDropZoneImage.color = hovering
                ? new Color(0.95f, 0.92f, 0.18f, 1f)
