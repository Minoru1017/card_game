...
/// <summary>M-1-3 分波對決教練 UI（<see cref="M13BattleCoachCatalog"/>）。</summary>
public sealed class M13BattleCoachUi : MonoBehaviour
{
    ...
    private void EvaluateHints()
    {
        ...
        bool ok = M13BattleCoachCatalog.TryEvaluate(_manager, out string key, out string message);
        ...
        if (_speakerText != null)
            _speakerText.text = M13BattleCoachCatalog.SpeakerName;
        if (_bodyText != null)
    ...
    private void EnsureUi()
    {
        ...
        _uiBuilt = true;
        _root = new GameObject("M13BattleCoach", typeof(RectTransform));
        ...
        outline.effectColor = new Color(0.55f, 0.78f, 0.88f, 0.95f);
        ...
        _speakerText.color = new Color(0.75f, 0.92f, 0.98f, 1f);
    ...
    {
        if (tmp == null) return;
        TMP_FontAsset font = _preferredFont ?? SettingsUiFonts.ResolveParameterDetailsFont();
        if (font != null)
            tmp.font = font;
    }
}
